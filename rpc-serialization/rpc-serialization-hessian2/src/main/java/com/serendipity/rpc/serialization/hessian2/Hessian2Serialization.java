package com.serendipity.rpc.serialization.hessian2;
...
public class Hessian2Serialization implements Serialization {
    ...
    private Logger logger = LoggerFactory.getLogger(Hessian2Serialization.class);

    @Override
    public <T> byte[] serialize(T obj) {
        logger.info("execute hessian2 serialize...");
        if (obj == null) {
            throw new SerializerException("serialization obj is null...");
        }
