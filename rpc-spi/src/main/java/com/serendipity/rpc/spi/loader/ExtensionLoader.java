package com.serendipity.rpc.spi.loader;
...
public final class ExtensionLoader<T> {
    ...
    private static final String SERENDIPITY_DIRECTORY = "META-INF/serendipity/";
    private static final String SERENDIPITY_DIRECTORY_EXTERNAL = "META-INF/serendipity/external/";
    private static final String SERENDIPITY_DIRECTORY_INTERNAL = "META-INF/serendipity/internal/";

    private static final String[] SPI_DIRECTORIES = new String[]{
            SERVICES_DIRECTORY,
            SERENDIPITY_DIRECTORY,
            SERENDIPITY_DIRECTORY_EXTERNAL,
            SERENDIPITY_DIRECTORY_INTERNAL
    };
